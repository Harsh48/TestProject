...
CREATE TABLE `Sale` (
    ...
    `saleAmountPaid` DOUBLE NULL,
    `taxAmount` DOUBLE NULL,
    `paymentStatus` ENUM('PENDING', 'SUCCESS', 'FALIURE') NOT NULL DEFAULT 'PENDING',
    `shipmentStatus` ENUM('PENDING', 'PACKED', 'SHIPPED', 'DELIVERED') NOT NULL DEFAULT 'PENDING',
